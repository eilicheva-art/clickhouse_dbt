        ...
        insert into `silver`.`ecommerce__products`
        ("id", "cost", "category", "name", "brand", "retail_price", "department", "sku", "distribution_center_id", "distribution_center_name", "profit", "_loaded_at", "_source")
