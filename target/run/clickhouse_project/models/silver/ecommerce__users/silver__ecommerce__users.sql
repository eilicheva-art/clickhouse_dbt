        ...
        insert into `silver`.`ecommerce__users`
        ("id", "full_name", "email", "age", "gender", "state", "street_address", "postal_code", "city", "country", "traffic_source", "created_at", "_loaded_at", "_source")
